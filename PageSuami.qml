...
Page {
    ...
    Dialog{
        ...
        title: "informasi"
        Text {
            text: qsTr("Data Berhasil Diubah")
        }
    }
    ...
    GroupBox{
        ...
        GridLayout{
                    ...
                    onClicked: {
                        if (nm_suami.text==""){
                            ...
                            txtdaftar.focus=true
                                            ...
                                            crud.simpansuami( nm_suami.text, tmp_lahir.text, tgl_lahir.text, warga_negara.text,
            ...
            //                    crud.simpansuami(idsuami.text, nm_suami.text, tmp_lahir.text, tgl_lahir.text, warga_negara.text,
            //                                           agama.currentText, pekerjaan.text, alamat.text, pendidikan.text)
            Button{
                id:btnupdate
                text:"Update"
                ...
                font.pixelSize: 12
                onClicked: {
                    crud.editsuami(idsuami.text, nm_suami.text, tmp_lahir.text, tgl_lahir.text, warga_negara.text,
                                           agama.currentText, pekerjaan.text, alamat.text, pendidikan.text)
